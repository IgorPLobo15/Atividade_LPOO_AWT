...
public class Ex_5 extends Frame implements ActionListener{
    ...
    public Ex_5(){
        ...
        B6 = new Button("Branco");
        B6.addActionListener(this);

        L1 = new Label("A cor é verde");
        L2 = new Label("A cor é laranja");
        L3 = new Label("A cor é Amarelo");
        L4 = new Label("A cor é Vermelho");
        L5 = new Label("A cor é Azul");
        L6 = new Label("A cor é Branco");
